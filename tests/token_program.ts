...
//     // Convert hex root string to [u8; 32] format
//     const newMerkleRoot = Array.from(
//       Buffer.from(merkleData.root.slice(2), "hex") // Remove "0x" and decode hex
//     );
    
//     // Optional: sanity check
//     if (newMerkleRoot.length !== 32) {
//       throw new Error("Invalid Merkle root length. Must be exactly 32 bytes.");
//     }
